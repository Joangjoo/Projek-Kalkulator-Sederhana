...
public class Kalkulator {
    ...
    public Kalkulator() {
        ...
        poinButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (tfHitungan.getText().equals("")){
                    tfHitungan.setText("0.");
                }else if (tfHitungan.getText().contains(".")){
                    poinButton.setEnabled(false);
                }else {
                    String Tombolkoma = tfHitungan.getText() + poinButton.getText();
                    tfHitungan.setText(Tombolkoma);
                }
                poinButton.setEnabled(true);
            }
        });
